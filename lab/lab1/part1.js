...
var printMenu = function(foodList) {
  console.log('Cake');
  _.each(foodList.Cake, function(food) {console.log(food.name + ' ... $' + food.price);});
  console.log('Bread');
  _.each(foodList.Bread, function(food) {console.log(food.name + ' ... $' + food.price);});
};
...
var printMenu = function(foodList) {
  ...
  _.each(foodList.Cake, function(food) {console.log(compiled(food));});
  console.log('Bread');
  _.each(foodList.Bread, function(food) {console.log(compiled(food));});
};
