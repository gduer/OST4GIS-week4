...
//downloadData.then(makeMarkers(downloadData)).then(plotMarkers(downloadData));
...
var makeMarkers = function(data) { return _.map(data, function(item){ return L.marker([item.LAT, item.LONG_]);});};
